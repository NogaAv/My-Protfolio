...
const CANVAS_WIDTH = (canvas.width = 2700); //we give the same value as in the styles.css file
const CANVAS_HEIGHT = (canvas.height = 700);
const layersPath = './src/intro-animation/backgroundLayers';
let gameSpeed = 3;

const backgroundLayer1 = new Image(); //exactly like: document.createElement("img");
backgroundLayer1.src = `${layersPath}/layer-1.png`;
const backgroundLayer2 = new Image();
backgroundLayer2.src = `${layersPath}/layer-2.png`;
const backgroundLayer3 = new Image();
backgroundLayer3.src = `${layersPath}/layer-3.png`;
const backgroundLayer4 = new Image();
backgroundLayer4.src = `${layersPath}/layer-4.png`;
const backgroundLayer5 = new Image();
backgroundLayer5.src = `${layersPath}/layer-5.png`;
